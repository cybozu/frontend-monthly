...
パフォーマンスに関するチェックリストです。77個のチェックリストがありますが、長大なので挫折しそうな人はサマライズされている [PDF](https://www.dropbox.com/s/34noajrbm324iai/performance-checklist-1.4.pdf) が読みやすかったので、PDF版を読んでみて気になるところは記事のほうを読んでみると良さそうと思いました。
あと記事の最後には**Quic Wins**として1時間で改善できる17個のことを記事中からピックアップされています。まずはこれからはじめるのも良さそうです。
