...
WWDC 2020の[Meet Face ID and Touch ID for the web](https://developer.apple.com/videos/play/wwdc2020/10670/)の記事版。動画よりもコード多めで詳細に解説。

- Web Authn APIのオプションとSafari上のUIがどう紐づくか
- 仕様と違う点
  - Touch ID/Face IDを使ったWeb Authn APIの呼び出しはユーザーインタラクションが必要
