...
- [Testing npm's trusted publishing - publish packages without tokens](https://roboin.io/article/2025/08/12/testing-npm-trusted-publishing-publish-packages-without-tokens/)
...
- [use-chat-submit](https://github.com/catnose99/use-chat-submit)
...
- [Storybook v10 のマイグレーションガイド](https://storybook.js.org/docs/10/releases/migration-guide)
  - ESM only になるなど、Storybook v10 への移行方法を解説
- [Google Doc みたいな共同編集機能を実装するためのライブラリ](https://ics.media/entry/250821/)
  - リアルタイム共同編集機能を Web アプリケーションに実装するためのライブラリの紹介

### ⚡️ Services

- [npm OIDC を使った trusted publishing で、GitHub Actions からトークンレスで npm パッケージを公開する](https://efcl.info/2025/09/07/npm-oidc/)
...
- [AI エージェントのコード出力を改善するための AGENTS.md ファイルの重要性とその作成方法について](https://www.builder.io/blog/agents-md)
...
- [Chrome 140 リリース](https://developer.chrome.com/blog/new-in-chrome-140?hl=ja)
...
- [僕らのいない違う世界線の JS](https://zenn.dev/mod_poppo/articles/isekai-javascript)
  - 昔の仕様にあった挙動や、策定途中で夢破れた JavaScript の仕様をまとめた記事
- [Fetch の仕様についてと、ブラウザと serverSide で求められる挙動とかも違うのでは？みたい話](https://susisu.hatenablog.com/entry/2025/08/31/190757)
...
- [CSS で擬似要素につける content プロパティと、その代替テキストの話](https://www.sarasoueidan.com/blog/alt-text-for-css-generated-content/)
...
- [アクセシブルな認証の話](https://afixt.com/accessible-authentication/)
...
- [padding とか疑似要素とかを使って、視覚的なサイズは変えずに当たり判定だけ大きくするテクニック](https://yuheiy.com/2025-09-12-click-friendly-target-areas)
...
- [useEffect の第二引数に object を渡してしまい、セルフ DDoS をやってしまった話](https://blog.cloudflare.com/deep-dive-into-cloudflares-sept-12-dashboard-and-api-outage/)
...
- [React Router の Middleware 機能](https://remix.run/blog/middleware)
