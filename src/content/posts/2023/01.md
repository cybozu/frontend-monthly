...
- ついに入った EcmaScript Decorators
  - 計画自体は4.8からされていた EcmaScript Decorator がついに入った
  - 文法的な部分はもちろん以下のようなポイントも書かれているので読んでおくと良さそう
    - TypeScriptが元々サポートしていたいわゆる Legacy Decorator との共存
...
- 複数の tsconfigをまとめて extendsできて便利
  - monorepoにしていたり、環境やコマンドごとにconfigを複数分けているような場合に便利そう
...
- そのほか面白そうなもアップデート
  ...
  - type only import をJS書き出し時により細かく削除するオプション `--verbatimModuleSyntax ` 
